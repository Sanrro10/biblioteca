 ...
 */
public class JCalendario extends JPanel implements PropertyChangeListener {
	...
	/**
	 * JCalendario constructor which allows the initial date to be set.
	 * 
	 * @param date
	 *            the date
	 */
	...
	/**
	 * JCalendario constructor which allows the initial calendar to be set.
	 * 
	 * @param calendar
	 *            the calendar
	 */
	...
	/**
	 * JCalendario constructor allowing the initial locale to be set.
	 * 
	 * @param locale
	 *            the new locale
	 */
	...
	/**
	 * JCalendario constructor specifying both the initial date and locale.
	 * 
	 * @param date
	 *            the date
	 * @param locale
	...
	/**
	 * JCalendario constructor specifying both the initial date and the month
	 * spinner type.
	 * 
	 * @param date
	 *            the date
	...
	/**
	 * JCalendario constructor specifying both the locale and the month spinner.
	 * 
	 * @param locale
	 *            the locale
	 * @param monthSpinner
	...
	/**
	 * JCalendario constructor specifying the month spinner type.
	 * 
	 * @param monthSpinner
	 *            false, if no month spinner should be used
	 */
	...
	/**
	 * JCalendario constructor with month spinner parameter.
	 * 
	 * @param date
	 *            the date
	 * @param locale
	...
	/**
	 * Creates a JFrame with a JCalendario inside and can be used for testing.
	 * 
	 * @param s
	 *            The command line arguments
	 */
	public static void main(String[] s) {
		JFrame frame = new JFrame("JCalendario");

		JCalendario jcalendar = new JCalendario();
	...
	/**
	 * Gets the dayChooser attribute of the JCalendario object
	 * 
	...
	/**
	 * Gets the monthChooser attribute of the JCalendario object
	 * 
	...
	/**
	 * Gets the yearChooser attribute of the JCalendario object
	 * 
	...
	/**
	 * JCalendario is a PropertyChangeListener, for its day, month and year
	 * chooser.
	 * 
	 * @param evt
	...
	/**
	 * Sets the calendar attribute of the JCalendario object
	 * 
	 * @param c
	...
	/**
	 * Enable or disable the JCalendario.
	 * 
	 * @param enabled
